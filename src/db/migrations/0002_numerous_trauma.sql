...
INSERT INTO "services" ("id", "slug", "title", "description", "long_description", "icon", "price_label", "features", "sort_order") VALUES
	('service-full-cycle-web', 'full-cycle-web', 'Full-Cycle Web & SaaS Engineering',
		...
		ARRAY['End-to-end architecture (DB to UI)','Strict TypeScript & Drizzle ORM','Next.js 16 App Router & React 19','Scalable REST & RPC API design'], 1),
	('service-ai-agentic', 'ai-agentic', 'Autonomous AI Agents & Workflows',
		...
		'bot', 'Custom Scope',
		ARRAY['Model Context Protocol (MCP) tools','Multi-step tool calling & agent loops','Structured LLM outputs & schemas','Gemini & Claude enterprise APIs'], 2),
	('service-architecture-advisory', 'architecture-advisory', 'Performance & Architecture Advisory',
		...
		ARRAY['Sub-second P95 latency & CWV audit','Database query & indexing optimization','CI/CD automation & edge deployment','Codebase modernization & review'], 3);--> statement-breakpoint
