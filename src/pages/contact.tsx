...
const contactDetails = [
	{
		icon: Mail,
		title: "Email",
		content: "hi@wismannur.pro",
		link: "mailto:hi@wismannur.pro",
	},
	// {
	//   icon: Phone,
	//   title: "Phone or WhatsApp",
	//   content: "+62 823-1927-2175",
	//   link: "tel:+6282319272175",
	// },
	{
		icon: MapPin,
		title: "Location",
	...
	},
	{
		icon: Clock,
		title: "Time Zone",
		content: "Western Indonesian Time, UTC+07:00",
	},
];

const socialLinks = [
	{ icon: Github, url: "https://github.com/wismannur", label: "GitHub" },
	{ icon: Twitter, url: "https://x.com/wismannur", label: "Twitter" },
	{
		icon: Linkedin,
		url: "https://linkedin.com/in/wismannur",
		label: "LinkedIn",
	},
];
