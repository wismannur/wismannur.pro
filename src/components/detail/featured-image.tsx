...
const FeaturedImage = ({ image, alt }: FeaturedImageProps) => {
  ...
  return (
    <div className="relative mb-10 rounded-3xl overflow-hidden border border-white/[0.08] shadow-2xl animate-scale-in aspect-[21/9]">
      <Image src={image} alt={alt} fill priority unoptimized className="object-cover" />
    </div>
  );
};
