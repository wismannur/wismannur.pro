...
const AuthorBio = () => {
	...
	const socialLinks = [
		{
			name: "LinkedIn",
			url: authorData?.linkedinUrl || "https://linkedin.com/in/wismannur",
			icon: <Linkedin size={16} />,
		},
		{
			name: "GitHub",
			url: authorData?.githubUrl || "https://github.com/wismannur",
			icon: <Github size={16} />,
		},
		{
			name: "Email",
			url: `mailto:${authorData?.email || "hi@wismannur.pro"}`,
			icon: <Mail size={16} />,
		},
	];
