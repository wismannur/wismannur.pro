        ...
        <Container style={container}>
          ...
          <Section style={bodySection}>
            ...
            <Text style={paragraph}>
              Thank you for reaching out regarding the opportunity for <strong>{roleTitle}</strong>{" "}
              at <strong>{company}</strong> via{" "}
            ...
            <Text style={paragraph}>
              I appreciate this opportunity. I will review the company profile, role details, and
              technical fit thoroughly, and get back to you within{" "}
          ...
          <Section style={summaryCard}>
            ...
            <Text style={summaryItem}>
              <strong>Employment & Workplace:</strong> {formatEmployment(employmentType)} ·{" "}
          ...
          <Section style={footerSection}>
            <Text style={footerText}>
              This is an automated confirmation that your opportunity / hire request has been
              received.
            </Text>
