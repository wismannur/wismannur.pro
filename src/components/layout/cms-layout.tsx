...
import { CmsCopilotPanel } from "@/components/cms/copilot/cms-copilot-panel";
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          path: "/cms/frontend-mastery",
        },
      ],
    },
    {
      group: "Finder Project Hub",
      items: [
        {
          label: "Project Hunter",
          icon: <Crosshair className="h-4 w-4" />,
          path: "/cms/project-hunter",
        },
        {
          label: "Project Tracker",
          icon: <Kanban className="h-4 w-4" />,
          path: "/cms/project-tracker",
        },
        {
          label: "Project Outreaches",
          icon: <Rocket className="h-4 w-4" />,
          path: "/cms/project-outreaches",
        },
      ],
    },
    {
          ...
          <header className="h-16 border-b border-white/[0.08] flex items-center justify-between px-4 md:px-6 sticky top-0 bg-[#08090C]/85 backdrop-blur-xl z-20 shadow-sm">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <Button
                ...
                className="h-8 px-2.5 rounded-full text-xs font-semibold border-indigo-500/30 bg-indigo-500/10 text-indigo-300 hover:bg-indigo-500/20 hover:border-indigo-500/50 hover:text-white transition-all flex items-center gap-1.5"
                title="Open CMS AI Copilot (⌘J)"
              >
                <Sparkles size={13} className="text-indigo-400" />
                <span className="hidden sm:inline">Copilot</span>
                <kbd className="hidden sm:inline-block px-1.5 py-0.5 bg-white/[0.08] rounded text-[10px] text-gray-300 font-mono">
                  ⌘J
                </kbd>
              </Button>
