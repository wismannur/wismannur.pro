...
export function SpotlightCard({
  ...
  return (
    <div
      ...
      className={cn(
        "relative rounded-3xl border border-white/[0.08] bg-[#0C0E18]/85 backdrop-blur-xl overflow-hidden transition-all duration-300",
        className
      )}
      {...props}
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 rounded-[inherit] transition-opacity duration-300 z-0 !mt-0 !mb-0"
        style={{
          opacity,
      ...
      />
      <div className="relative z-10 h-full w-full !mt-0">{children}</div>
    </div>
  );
}
