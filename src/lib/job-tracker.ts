...
export const JOB_PLATFORM_CONFIG: Record<JobPlatform, { label: string; color: string }> = {
  // Direct ATS
  ashby: { label: "Ashby", color: "bg-emerald-600/10 text-emerald-500 border-emerald-500/25" },
  greenhouse: { label: "Greenhouse", color: "bg-teal-600/10 text-teal-500 border-teal-500/25" },
  lever: { label: "Lever", color: "bg-indigo-600/10 text-indigo-500 border-indigo-500/25" },

  // Global Feeds
  arbeitnow: { label: "Arbeitnow", color: "bg-amber-600/10 text-amber-500 border-amber-500/25" },
  remoteok: { label: "RemoteOK", color: "bg-rose-600/10 text-rose-500 border-rose-500/25" },
  remotive: { label: "Remotive", color: "bg-purple-600/10 text-purple-500 border-purple-500/25" },
  jobicy: { label: "Jobicy", color: "bg-blue-600/10 text-blue-500 border-blue-500/25" },
