...
export const JOB_PLATFORM_CONFIG: Record<
	JobPlatform,
...
> = {
	...
	techinasia: { label: "Tech in Asia", color: "bg-amber-600/10 text-amber-600 border-amber-600/20" },
	indeed: { label: "Indeed", color: "bg-blue-600/10 text-blue-600 border-blue-600/20" },
	company_website: { label: "Company Careers", color: "bg-emerald-600/10 text-emerald-600 border-emerald-600/20" },
...
export const INTERVIEW_STAGE_CONFIG: Record<
	InterviewStageType,
...
export function formatSalary(
	...
	const periodSuffix =
		period === "monthly" ? "/mo" : period === "yearly" ? "/yr" : "/hr";
