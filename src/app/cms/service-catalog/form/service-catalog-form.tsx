									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<div className="text-xs text-muted-foreground mt-1">
													Longer variant shown on the home page; falls back to the short
													description
												</div>
												<FormMessage />
											</FormItem>
								...
								<Card className="border-border/50 shadow-md rounded-xl overflow-hidden">
									...
									<CardContent className="p-4">
										<div className="text-xs space-y-2 text-muted-foreground">
											<p>
												<span className="font-semibold">Descriptions:</span> The short
												description is used on /services and /hire-me; the long one only on the
												home page
											</p>
											<p>
											...
											<p>
												...
												to keep a service out of the public pages without deleting it
											</p>
										</div>
									</CardContent>
								</Card>
