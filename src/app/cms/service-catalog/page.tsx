...
export default function CmsServiceCatalogPage() {
  ...
  useRegisterCmsPageContext({
    ...
    summary: `Managing ${stats.total} services (${stats.published} published, ${stats.homeCount} on home, ${stats.hireMeCount} on hire-me). Page ${currentPage}.`,
    activeItems: filteredServices.map((s) => ({
      id: s.id,
      title: s.title,
      slug: s.slug,
  ...
  return (
    <div className="space-y-6">
      <CmsPageHeader
        ...
        description="Manage offerings shown on home, /services, and /hire-me"
