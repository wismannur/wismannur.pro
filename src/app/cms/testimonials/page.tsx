...
export default function CmsTestimonialsPage() {
  ...
  useRegisterCmsPageContext({
    ...
    summary: `Managing ${stats.total} testimonials (${stats.publishedCount} published, ${stats.hiddenCount} hidden, avg rating ${stats.avgRating}★). Page ${currentPage}.`,
    activeItems: filteredTestimonials.map((t) => ({
      id: t.id,
  ...
  return (
    <div className="space-y-6">
      ...
      <CmsPageHeader
        icon={Quote}
        title="Testimonials"
        description="Manage client testimonials on /hire-me — the section hides automatically when none are published"
