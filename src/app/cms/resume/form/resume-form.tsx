										...
										render={({ field }) => (
											<FormItem>
												...
												<FormControl>
													<Input
														placeholder={
															isExperience ? "Rumah Siap Kerja" : "Freecodecamp.org"
														}
														className="rounded-lg border-border/50 focus-visible:ring-primary/30"
														{...field}
													/>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<div className="text-xs text-muted-foreground mt-1">
														Leave at 0 for newest first. A higher number pins the entry above
														the rest.
													</div>
													<FormMessage />
												</FormItem>
									...
									<CardContent className="p-4">
										<div className="text-xs space-y-2 text-muted-foreground">
											<p>
												...
												"Problem:", "Role:", "Action:" or "Quantifiable results:" and the about
												page highlights them automatically
											</p>
											<p>
												<span className="font-semibold">Order:</span> Entries sort newest first
												from the start month — no manual ordering needed
											</p>
											<p>
												<span className="font-semibold">Education:</span> Only the year is shown,
												so any month within the right year works
											</p>
											<p>
												<span className="font-semibold">Hidden:</span> Use the publication toggle
												to keep an entry out of the public page without deleting it
											</p>
										</div>
									</CardContent>
								</Card>
