...
import { ArrowRight, Check, Info, Loader2, Package, Save, Settings2 } from "lucide-react";
                ...
                <Card className="border-border/50 shadow-md rounded-xl overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    <div className="text-xs space-y-2 text-muted-foreground">
                      ...
                      <p>
                        <span className="font-semibold">Extras:</span> Short, scannable bullets sell
                        better than long sentences
                      </p>
                      <p>
                        <span className="font-semibold">Hidden:</span> Use the publication toggle to
                        keep an offer out of the public page without deleting it
                      </p>
                    </div>
                  </CardContent>
                </Card>
