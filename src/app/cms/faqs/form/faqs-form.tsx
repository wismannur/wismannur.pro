                ...
                <Card className="border-border/50 shadow-md rounded-xl overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    <div className="text-xs space-y-2 text-muted-foreground">
                      <p>
                        <span className="font-semibold">Question:</span> Phrase it the way a client
                        would ask it — short and specific
                      </p>
                      <p>
                      ...
                      <p>
                        <span className="font-semibold">Shared:</span> The same FAQ list is shown on
                        both /services and /hire-me
                      </p>
                      <p>
                        <span className="font-semibold">Hidden:</span> Use the publication toggle to
                        keep an entry out of the public pages without deleting it
                      </p>
                    </div>
                  </CardContent>
                </Card>
