					...
					<Card className="border-border/50 bg-card/60 shadow-sm">
							...
							<div className="flex flex-wrap items-start justify-between gap-4">
								<div>
									...
									<p className="text-xs text-muted-foreground mt-1 flex items-center gap-1.5">
										...
										Received on {format(new Date(request.createdAt), "EEEE, dd MMMM yyyy · HH:mm")} WIB
									</p>
								</div>
						...
						<CardContent className="pt-2">
							...
							<div className="grid grid-cols-2 sm:grid-cols-4 gap-3 p-3.5 rounded-xl bg-background/60 border border-border/40">
								...
								<div>
									<span className="text-[11px] text-muted-foreground block mb-0.5">Compensation</span>
											...
											>
												<div className="flex items-center justify-between text-muted-foreground">
													<div className="flex items-center gap-2 font-medium">
														<span className={isAdmin ? "text-primary font-semibold" : "text-foreground font-semibold"}>
					...
					<Card className="border-border/50 bg-card/60 shadow-sm">
						...
						<CardContent className="pt-4 space-y-4 text-xs">
							...
							<div className="space-y-3">
								...
								<div>
									<span className="text-[11px] text-muted-foreground block mb-0.5">Inquiry ID:</span>
							...
							<div className="pt-2">
								<Button variant="outline" size="sm" className="w-full gap-2 text-xs" asChild>
									<a href={`mailto:${request.email}?subject=Re: ${encodeURIComponent(request.roleTitle)} - Wisman Nur`}>
			...
			<AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Are you sure you want to delete this hire inquiry from{" "}
							<strong>{request.name}</strong> ({request.company})? This action cannot be undone.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
