...
> = {
  ...
  follow_up_due: {
    ...
    className:
      "bg-amber-500/15 text-amber-600 dark:text-amber-400 border-amber-500/30 animate-pulse font-semibold",
    icon: AlertCircle,
  },
  replied: {
    label: "Replied 🎉",
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Manage cold outreach, direct email applications, and track recruiter replies seamlessly
            through <strong className="text-foreground">{PUBLIC_SUPPORT_EMAIL}</strong>.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
        <Card className="bg-card/50 backdrop-blur-sm border-border/50 shadow-sm">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold mt-2">{analytics?.totalOutreaches ?? 0}</div>
          </CardContent>
        </Card>
              ...
              >
                <CardHeader className="p-4 pb-3 space-y-2.5">
                  ...
                  <div className="flex flex-wrap items-center gap-1.5">
                    <Badge
                      variant="outline"
                      className={cn(
                        "text-[11px] font-medium border gap-1 py-0.5",
                ...
                <CardContent className="p-4 pt-0 space-y-3">
                  ...
                  <div className="pt-2 border-t border-border/40 flex items-center justify-between text-[11px] text-muted-foreground">
                    ...
                    {item.jobApplication && (
                      <Badge variant="secondary" className="text-[10px] bg-muted py-0 h-5">
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action will delete the outreach data along with all associated email thread
              conversations.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
