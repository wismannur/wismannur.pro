			...
			<DialogContent className="max-w-lg">
					...
					<div className="flex items-center gap-2">
						...
						<div>
							...
							<DialogDescription className="text-xs">
								Log feedback and self-reflection for <strong>{jobTitle}</strong> at <strong>{companyName}</strong>.
							</DialogDescription>
						</div>
					</div>
				</DialogHeader>
				...
				<div className="space-y-4 pt-2 text-xs">
					<div className="space-y-1.5">
						<Label htmlFor="stageFailed" className="text-xs">Final Stage Reached</Label>
					...
					<div className="space-y-1.5">
						<Label htmlFor="reasonCategory" className="text-xs">Primary Factor</Label>
						<Select value={primaryReason} onValueChange={setPrimaryReason}>
							<SelectTrigger className="text-xs">
								<SelectValue />
							</SelectTrigger>
							<SelectContent>
								<SelectItem value="Skill / Tech Stack Mismatch">Skill / Tech Stack Alignment</SelectItem>
								<SelectItem value="Found more senior candidate">Found Candidate with More Domain Experience</SelectItem>
								<SelectItem value="Salary budget mismatch">Salary / Budget Mismatch</SelectItem>
								<SelectItem value="Cultural / Communication Fit">Communication / Cultural Fit</SelectItem>
								<SelectItem value="Position Cancelled / Hiring Freeze">Headcount Frozen / Position Cancelled</SelectItem>
								<SelectItem value="Ghosted / Recruiter Stopped Responding">No Response / Recruiter Ghosted</SelectItem>
					...
					<div className="space-y-1.5">
						<Label htmlFor="recruiterFeedback" className="text-xs">Recruiter / Interviewer Feedback</Label>
						<Textarea
					...
					<div className="space-y-1.5">
						<Label htmlFor="lessonsLearned" className="text-xs flex items-center gap-1.5 text-primary font-bold">
