          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3">
            <div>
              ...
              <CardDescription className="text-xs">
                Break down base compensation, performance bonuses, stock options, health benefits,
        ...
        <Card className="border-border/80 shadow-sm space-y-4">
          ...
          <CardContent className="space-y-2.5 text-xs text-muted-foreground">
            <div className="flex items-start gap-2 p-2 rounded-lg bg-muted/30 border border-border/40">
              ...
              <div>
                <span className="font-semibold text-foreground">Health & Dental:</span> BPJS
                Ketenagakerjaan & Kesehatan + Private Inpatient/Outpatient/Dental.
              </div>
            </div>
            ...
            <div className="flex items-start gap-2 p-2 rounded-lg bg-muted/30 border border-border/40">
              ...
              <div>
                <span className="font-semibold text-foreground">Hardware & Remote:</span> High-tier
                Laptop (MacBook Pro / ThinkPad) + Home Office Setup allowance.
              </div>
            </div>
            ...
            <div className="flex items-start gap-2 p-2 rounded-lg bg-muted/30 border border-border/40">
              ...
              <div>
                <span className="font-semibold text-foreground">Annual Bonus & THR:</span> 1 Month
                THR (Mandatory) + 1-3 Months KPI Performance Bonus.
              </div>
            </div>
          </CardContent>
        </Card>
