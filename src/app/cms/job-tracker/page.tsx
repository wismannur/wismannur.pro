			...
			<div className="flex flex-col md:flex-row justify-between gap-4 items-start md:items-center">
				<div>
					...
					<p className="text-sm text-muted-foreground mt-1">
						Track opportunities, match & tailor CV with Gemini AI, simulate interviews, and monitor hiring pipeline
					</p>
				</div>
					...
					<div className="flex flex-wrap sm:flex-nowrap gap-2.5 items-center">
						...
						<Select value={platformFilter} onValueChange={setPlatformFilter}>
							...
							<SelectContent>
								...
								<SelectItem value="jobstreet" className="text-xs">Jobstreet</SelectItem>
								<SelectItem value="glints" className="text-xs">Glints</SelectItem>
								<SelectItem value="techinasia" className="text-xs">Tech in Asia</SelectItem>
								<SelectItem value="indeed" className="text-xs">Indeed</SelectItem>
								<SelectItem value="company_website" className="text-xs">Company Web</SelectItem>
						...
						{viewMode === "table" && (
							<Select value={statusFilter} onValueChange={setStatusFilter}>
								...
								<SelectContent>
									...
									<SelectItem value="wishlist" className="text-xs">Wishlist</SelectItem>
									...
									<SelectItem value="interview_hr" className="text-xs">HR Interview</SelectItem>
									<SelectItem value="interview_tech" className="text-xs">Tech Interview</SelectItem>
									<SelectItem value="interview_user" className="text-xs">User Interview</SelectItem>
									<SelectItem value="offering" className="text-xs">Offering</SelectItem>
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							This will permanently remove this job opportunity and all recorded interview sessions, ATS tailoring, and notes from your tracker.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
