										...
										render={({ field }) => (
											<FormItem>
												<FormLabel className="text-foreground/80 font-medium flex items-center">
													Icon
													{SelectedIcon && (
														<SelectedIcon className="h-4 w-4 ml-2 text-primary" />
													)}
												</FormLabel>
												<Select onValueChange={field.onChange} value={field.value}>
													<FormControl>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<div className="text-xs text-muted-foreground mt-1">
														Lower numbers appear first. Step numbers (01, 02, …) follow this
														order automatically.
													</div>
													<FormMessage />
												</FormItem>
									...
									<CardContent className="p-4">
										<div className="text-xs space-y-2 text-muted-foreground">
											<p>
												...
												…) are derived from the display order automatically — no need to put
												them in the title
											</p>
											<p>
											...
											<p>
												<span className="font-semibold">Scope:</span> Each page owns its own set
												of steps — switch the scope to move a step between pages
											</p>
											<p>
												<span className="font-semibold">Hidden:</span> Use the publication toggle
												to keep a step out of the public page without deleting it
											</p>
										</div>
									</CardContent>
								</Card>
