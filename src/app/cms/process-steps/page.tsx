					...
					>
						<DropdownMenu>
							...
							<DropdownMenuContent align="end">
								<DropdownMenuItem
									onClick={() =>
										router.push(step.scope === "hire-me" ? "/hire-me" : "/services")
									}
								>
						...
						<AlertDialogContent>
							<AlertDialogHeader>
								...
								<AlertDialogDescription>
									This action cannot be undone. This will permanently delete the "{step.title}"
									step from /{step.scope === "hire-me" ? "hire-me" : "services"}.
								</AlertDialogDescription>
							</AlertDialogHeader>
							<AlertDialogFooter>
