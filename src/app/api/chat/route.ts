...
import { logChatInteraction } from "@/services/ai-chat/logging";
...
function getClientIp(req: NextRequest): string {
  // Prioritize trusted edge proxy headers before raw client-forwarded headers
  ...
  if (forwarded) {
    // If multiple IPs are chained, take the last proxy entry or clean first
