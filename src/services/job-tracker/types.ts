...
export interface CompanyIntelligence {
  ...
  timezone?: string; // IANA identifier, e.g. "Europe/Amsterdam"
}

export interface InboundReachoutReplyDraft {
  id: string;
...
export interface InboundReachout {
  recruiterName?: string;
  recruiterRole?: string;
  platform?: "linkedin_inmail" | "linkedin_connect" | "email" | "other";
  messageRaw?: string;
  receivedAt?: string;
  keyInsights?: string[];
  replyDrafts?: InboundReachoutReplyDraft[];
  sentReplyContent?: string;
  sentAt?: string;
}
...
export interface JobApplication {
  ...
  inboundReachout?: InboundReachout;
  createdAt: Date;
  updatedAt: Date;
