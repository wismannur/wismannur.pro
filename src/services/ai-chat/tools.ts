...
import type { SubmitContactMessageArgs, SubmitHireInquiryArgs, ToolExecutionResult } from "./types";
    ...
    functionDeclarations: [
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            employmentType: {
              type: Type.STRING,
              description: "Employment type: full_time, contract, part_time, freelance, internship",
              enum: ["full_time", "contract", "part_time", "freelance", "internship"],
            },
            workplaceType: {
              type: Type.STRING,
