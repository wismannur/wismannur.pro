...
const settingsUpdateSchema = z.object({
  ...
  social: z.object({ github: z.string(), twitter: z.string(), linkedin: z.string() }).optional(),
...
export async function uploadContentImage(formData: FormData): Promise<string> {
  ...
  if (typeof previousUrl === "string" && previousUrl.includes(".public.blob.vercel-storage.com/")) {
